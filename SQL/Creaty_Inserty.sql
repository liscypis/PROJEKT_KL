...
insert into oferty values(oferty_seq.nextval,'Legoland [Kraków - Billund]',130,'2017-05-04','2017-05-05',5);
insert into oferty values(oferty_seq.nextval,'Festiwal Piwa [Warszawa - Hamburg]',99,'2017-06-05','2017-06-07',4);
insert into oferty values(oferty_seq.nextval,'Ostrawa [£ódŸ - Czechy]',109,'2017-04-05','2022-04-05',2);
...
insert into oferty values(oferty_seq.nextval,'[Kraków - Budapeszt]',479,'2017-08-01','2017-09-01',7);
insert into oferty values(oferty_seq.nextval,'[Wiedeñ - Bratys³awa - Brno]',529,'2018-01-05','2018-01-20',6);
insert into oferty values(oferty_seq.nextval,'Austria - Weekend w Wiedniu',609,'2017-09-08','2017-09-10',4);
insert into oferty values(oferty_seq.nextval,'Pary¿ 6 Dni - Komfort [Gdañsk - Pary¿]',709,'2018-12-05','2019-01-01',2);
insert into oferty values(oferty_seq.nextval,'[£ódŸ - Sztokholm]',432.43,'2017-07-07','2017-08-01',7);
insert into oferty values(oferty_seq.nextval,'W³oski Niezbêdnik [Warszawa - Rzym - Mediolan - Neapol]',809,'2017-11-11','2017-11-22',4);
...
insert into oferty values(oferty_seq.nextval,'[Kraków - Ateny]',700.50,'2017-09-01','2017-09-11',2);
...
insert into oferty values(oferty_seq.nextval,'Ba³kañskie Czary [Bu³garia - Rumunia]',467,'2017-11-01','2017-11-15',3);
insert into oferty values(oferty_seq.nextval,'City Break [Poznañ - Ateny]',947,'2017-07-02','2017-07-10',6);
...
insert into uzytkownicy values(uzytkownicy_seq.nextval,'Arkadiusz','Barczyñski','Arczi96','hasloHaslo');
...
insert into uzytkownicy values(uzytkownicy_seq.nextval,'Grzegorz','Stañco','Grzesiek','bestbesty');
...
insert into uzytkownicy values(uzytkownicy_seq.nextval,'Anna','Rabczyñska','AnnaKowalska','asdww2231');
insert into uzytkownicy values(uzytkownicy_seq.nextval,'Rafa³','Wierczyñski','Rafaello','fffghyt@1!');
