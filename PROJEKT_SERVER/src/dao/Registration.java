...
public class Registration {
    ...
    //INSERT uzytkownik
    //*************************************
    public static void addUser (String imie, String nazwisko, String login, String haslo) throws SQLException, ClassNotFoundException {
        //Declare a insert statement
        String updateStmt = "insert into uzytkownicy values(uzytkownicy_seq.nextval,'"+imie+"','"+nazwisko+"','"+login+"','"+haslo+"')";
        //Execute insert
        try {
